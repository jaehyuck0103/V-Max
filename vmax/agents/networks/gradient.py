...
# Source: https://github.com/google/brax/blob/main/brax/training/gradients.py
...
def loss_and_pgrad(
    ...
    Args:
        ...
        pmap_axis_name: The name of the pmapped axis for gradient averaging.
        has_aux: Flag indicating if auxiliary data is returned.

    Returns:
        The original value and grad function if no axis is provided,
        otherwise a function returning averaged gradients.
